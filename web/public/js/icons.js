// Lucide icons v1.47.0 (ISC licence, see vendor/LUCIDE_LICENSE.txt), inlined so the page
// needs no icon font or CDN. Generated from lucide-static; add an icon by copying its SVG body.
const PATHS = {
...
export function icon(name, size = 18, extraClass = "") {
  const body = PATHS[name] || PATHS["circle-alert"];
